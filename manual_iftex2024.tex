...
\begin{itemize}
  ...
  \item[] \comando{data[DD][MM]\{AAAA\}} -- substituir \textbf{DD} por dia, \textbf{MM} por mês e \textbf{AAAA} por ano, por parâmetros DD e MM são opcionais;
...
\begin{itemize}
  ...
  \item[] \comando{submissao[DD][MM]\{AAAA\}} -- substituir \textbf{DD} por dia, \textbf{MM} por mês e \textbf{AAAA} por ano, por parâmetros DD e MM são opcionais.
\end{itemize}
